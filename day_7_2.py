...
card_strength = {'A': 13, 'K': 12, 'Q': 11, 'T': 10, '9': 9, '8': 8, '7': 7, '6': 6, '5': 5, '4': 4, '3': 3, '2': 2, 'J': 1}
...
def adjust_joker(hand: str) -> str:
    ...
    hand_copy2 = str(hand)
    hand_copy2 = hand_copy2.replace('J', max_ch)

    return hand_copy2

def get_type(hand: str) -> int:
    hand = adjust_joker(hand=hand)
